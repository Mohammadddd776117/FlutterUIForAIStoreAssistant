...
class $StoresTable extends Stores with TableInfo<$StoresTable, Store> {
  ...
  List<GeneratedColumn> get $columns =>
      [id, name, ownerName, phone, address, createdAt];
  @override
...
class Store extends DataClass implements Insertable<Store> {
  ...
  @override
  int get hashCode =>
      Object.hash(id, name, ownerName, phone, address, createdAt);
  @override
...
class $BranchesTable extends Branches with TableInfo<$BranchesTable, Branche> {
  ...
  late final GeneratedColumn<String> address = GeneratedColumn<String>(
      ...
      type: DriftSqlType.string, requiredDuringInsert: true);
  @override
  List<GeneratedColumn> get $columns => [id, storeId, name, address];
  @override
  String get aliasedName => _alias ?? actualTableName;
  @override
  String get actualTableName => $name;
...
class Branche extends DataClass implements Insertable<Branche> {
  ...
  Branche copyWith({int? id, int? storeId, String? name, String? address}) =>
      Branche(
        id: id ?? this.id,
  ...
  @override
  int get hashCode => Object.hash(id, storeId, name, address);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is Branche &&
...
class $EmployeesTable extends Employees
  ...
  late final GeneratedColumn<String> phone = GeneratedColumn<String>(
      ...
      type: DriftSqlType.string, requiredDuringInsert: true);
  @override
  List<GeneratedColumn> get $columns => [id, branchId, name, role, phone];
  @override
  String get aliasedName => _alias ?? actualTableName;
  @override
  String get actualTableName => $name;
...
class Employee extends DataClass implements Insertable<Employee> {
  ...
  @override
  int get hashCode => Object.hash(id, branchId, name, role, phone);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is Employee &&
...
class $SalesTable extends Sales with TableInfo<$SalesTable, Sale> {
  ...
  @override
  List<GeneratedColumn> get $columns =>
      [id, productId, quantity, unitPrice, totalPrice, employeeId, createdAt];
  @override
  String get aliasedName => _alias ?? actualTableName;
  @override
  String get actualTableName => $name;
...
class $DebtsTable extends Debts with TableInfo<$DebtsTable, Debt> {
  ...
  @override
  List<GeneratedColumn> get $columns =>
      [id, customerId, amount, paid, remaining, createdAt];
  @override
  String get aliasedName => _alias ?? actualTableName;
  @override
  String get actualTableName => $name;
...
class Debt extends DataClass implements Insertable<Debt> {
  ...
  @override
  int get hashCode =>
      Object.hash(id, customerId, amount, paid, remaining, createdAt);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is Debt &&
...
class InventoryMovement extends DataClass
  ...
  @override
  int get hashCode => Object.hash(id, productId, type, quantity, createdAt);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
...
final class $$StoresTableReferences
  ...
  static MultiTypedResultKey<$BranchesTable, List<Branche>> _branchesRefsTable(
      ...
      MultiTypedResultKey.fromTable(db.branches,
          aliasName: $_aliasNameGenerator(db.stores.id, db.branches.storeId));
          ...
          prefetchHooksCallback: ({branchesRefs = false}) {
            return PrefetchHooks(
              ...
              getPrefetchedDataCallback: (items) async {
                return [
                  if (branchesRefs)
                    await $_getPrefetchedData<Store, $StoresTable, Branche>(
                        currentTable: table,
                        referencedTable:
                            $$StoresTableReferences._branchesRefsTable(db),
                        managerFromTypedResult: (p0) =>
                            $$StoresTableReferences(db, table, p0).branchesRefs,
...
final class $$BranchesTableReferences
  ...
  static $StoresTable _storeIdTable(_$AppDatabase db) => db.stores
      .createAlias($_aliasNameGenerator(db.branches.storeId, db.stores.id));
  ...
  static MultiTypedResultKey<$EmployeesTable, List<Employee>>
      _employeesRefsTable(_$AppDatabase db) =>
          MultiTypedResultKey.fromTable(db.employees,
              aliasName:
                  $_aliasNameGenerator(db.branches.id, db.employees.branchId));
...
class $$BranchesTableTableManager extends RootTableManager<
    ...
    Branche,
    PrefetchHooks Function({bool storeId, bool employeesRefs})> {
  $$BranchesTableTableManager(_$AppDatabase db, $BranchesTable table)
      : super(TableManagerState(
          ...
          withReferenceMapper: (p0) => p0
              ...
              .toList(),
          prefetchHooksCallback: ({storeId = false, employeesRefs = false}) {
            return PrefetchHooks(
              db: db,
              ...
              addJoins: <
                ...
                if (storeId) {
                  state = state.withJoin(
                    ...
                    referencedTable:
                        $$BranchesTableReferences._storeIdTable(db),
                    referencedColumn:
                        $$BranchesTableReferences._storeIdTable(db).id,
                  ) as T;
                }
                ...
                return [
                  if (employeesRefs)
                    await $_getPrefetchedData<Branche, $BranchesTable,
                        ...
                        currentTable: table,
                        referencedTable:
                            $$BranchesTableReferences._employeesRefsTable(db),
                        managerFromTypedResult: (p0) =>
...
final class $$EmployeesTableReferences
  ...
  static $BranchesTable _branchIdTable(_$AppDatabase db) => db.branches
      .createAlias($_aliasNameGenerator(db.employees.branchId, db.branches.id));
              ...
              addJoins: <
                ...
                if (branchId) {
                  state = state.withJoin(
                    ...
                    referencedTable:
                        $$EmployeesTableReferences._branchIdTable(db),
                    referencedColumn:
                        $$EmployeesTableReferences._branchIdTable(db).id,
                  ) as T;
                }
...
class $$ProductsTableTableManager extends RootTableManager<
    ...
    Product,
    PrefetchHooks Function({bool salesRefs, bool inventoryMovementsRefs})> {
  $$ProductsTableTableManager(_$AppDatabase db, $ProductsTable table)
      : super(TableManagerState(
          ...
          prefetchHooksCallback: (
              {salesRefs = false, inventoryMovementsRefs = false}) {
            return PrefetchHooks(
              db: db,
